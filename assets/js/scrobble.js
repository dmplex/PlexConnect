 ...
 */
function scrobbleMenu(type, ratingKey, addrPMS, viewShowOptionURL) {
 ...
 */
function viewShow(viewShowOptionURL) {
	var url = "http://atv.plexconnect" + viewShowOptionURL + "/children";
	atv.loadURL(url);
}
